...
public:
  If(MixedArena& allocator) : ifFalse(nullptr) {}
...
public:
  Break(MixedArena& allocator) : value(nullptr), condition(nullptr) {
    type = unreachable;
  }
...
public:
  Switch(MixedArena& allocator) : condition(nullptr), value(nullptr) {
    type = unreachable;
  }
...
public:
  Return(MixedArena& allocator) : value(nullptr) {
    type = unreachable;
  }
